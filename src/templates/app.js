...
async function fetchAllData() {
    try {
        ...
        try {
            // Priority: Get full user details including snoovatar via Reddit API
            ...
            if (currUser) {
                ...
                // Fallback to basic context info if Reddit API call fails
                user = { 
                    id: context.userId, 
            ...
            console.warn('User fetch failed, using Guest fallback', e); 
        }
