...
(function() {
    ...
    class AdapterCollection {
        ...
        create = async (data) => {
            ...
            // If the record includes identity fields, ensure they use current Reddit identity
            const identityOverrides = {};
            if (user) {
                if ('username' in data) identityOverrides.username = user.username;
                if ('avatar_url' in data) identityOverrides.avatar_url = user.avatar_url;
                if ('author' in data) identityOverrides.author = user.username;
            }
